...
htmlText += f'\t\t<h5 class="mx-5 py-2"><a href="pages/categories.html">Games Exerciess and Formats</a>\n\t</div>\n</header>\n<body>'
...
htmlEndText = f'</body>\n<footer>\n\t<div class="d-flex flex-wrap justify-content-around">\n'
htmlEndText += f'\t\t<h5 class="mx-5 py-2"><a href="index.html">Home</a>\n\t\t<h5 class="mx-5 py-2"><a href="pages/categories.html">Games Exerciess and Formats</a>\n'
htmlEndText += f'\t</div>\n</footer>\n</html>'
