...
def build_performance_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Performance</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and formats are suitable for live performance.</p>\n'
    ...
    # FILE NAME
    new_file = '../pages/performance.html'
