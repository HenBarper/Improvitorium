...
def build_song_formats_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Song Formats</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These are various improvised song formats.</p>\n'
    ...
    # FILE NAME
    new_file = '../pages/song_formats.html'
