...
def build_energy_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Energy</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises will get the enrgy up in a show or practice.</p>\n'
