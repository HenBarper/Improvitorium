...
def build_full_page(title, tag, html, page_description):
  print(f'Title: {title}, tag: {tag}, html: {html}')
  ...
  linkText = f'\t<h1 class="text-center my-3">{title}</h1>\n'
  linkText += f'\t<p class="text-center my-3">{page_description}</p>\n'
