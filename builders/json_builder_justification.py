...
def build_justification_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Justification</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises make players have to justify absurd choices or dialogue.</p>\n'
    ...
    # FILE NAME
    new_file = '../pages/justification.html'
