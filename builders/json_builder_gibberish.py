...
def build_gibberish_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Gibberish</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises involve scenes where players must act and/or communicate without any real dialogue, only gibberish or sometimes numbers.</p>\n'
