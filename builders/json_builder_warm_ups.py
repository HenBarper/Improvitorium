...
def build_warm_ups_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Warm Ups</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises are great for getting players warmed up before a show or rehearsal.</p>\n'
