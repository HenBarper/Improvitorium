...
def build_narrative_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Narrative</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises follow some form of narrative structure.</p>\n'
