...
def build_torture_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Torture</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games involve torturing players by making them justify extreme points of view, perform strenuous actions, and/or pushing their mental faculties to the limit.</p>\n'
