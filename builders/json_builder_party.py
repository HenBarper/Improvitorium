...
def build_party_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Party Games</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games are fun to play in large groups.</p>\n'
