...
def build_musical_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Musical</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises take improv into the musical realm, incorporating song and dance into our improv scenes.</p>\n'
