...
def build_scene_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Scene Work</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games and exercises involve the players making up the scene on the spot.</p>\n'
