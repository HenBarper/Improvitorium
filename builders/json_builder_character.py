...
def build_character_page_json():
    ...
    linkText = f'\t<h1 class="text-center my-3">Characters</h1>\n'
    linkText += f'\t<p class="text-center my-3">These games and exercises involve the exploration and/or discovery characters.</p>\n'
    linkText += f'\t<div class="m-5 games-list">\n'
    linkText += f'\t\t<ul class="py-3">\n'
    fullText = f'<div class="m-5">\n'

    for item in data:
        if 'Character' in item['tags']:
