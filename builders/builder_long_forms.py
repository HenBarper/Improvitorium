...
def build_long_forms_page():
  ...
  linkText = f'\t<h1 class="text-center my-3">Long Forms</h1>\n'
  linkText += f'\t<p class="text-center my-3">These formats serve as the basic for many verying long form shows.</p>\n'
  linkText += f'\t\t<div class="m-5 games-list">\n'
  linkText += f'\t\t\t<ul class="py-3">\n'
  fullText = f'<div class="m-5">\n'

  for item in data:
    if 'Long Form' in item[3]:
  ...
  new_file = '../pages/long_forms.html'
