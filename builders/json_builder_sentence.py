...
def build_sentence_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Sentence Games</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">These games invole reading dialogue provided by the audience on strips of paper before the show.</p>\n'
