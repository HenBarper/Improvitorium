...
def build_openings_page_json():
    ...
    # TITLE
    linkText = f'\t<h1 class="text-center my-3">Openings</h1>\n'
    # SUBTITLE
    linkText += f'\t<p class="text-center my-3">This page is dedicated to set openings for Harolds or other long forms.</p>\n'
